...
export class OrderComponent implements OnInit {
  ...
  public openOrderModal() {
    const initialState = {
      ...
      text: `Ваш заказ #${(Math.random() * (999999 - 100000) + 100000).toFixed(0)} находится в статусе Обработки. На вашу электронную почту было отправлено письмо с подробностями.`,
